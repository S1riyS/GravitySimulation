    ...
    def __init__(self):
        ...
        self.settings_block = {
            'elements': {
                ...
                'planet_mass_slider': UIHorizontalSlider(relative_rect=pygame.Rect(65, 260, 145, 20), start_value=150,
                                                         value_range=(50, 450), manager=self.manager),
                ...
                'star_mass_label': UILabel(relative_rect=pygame.Rect(10, 365, 50, 30), text='Mass:',
                                           manager=self.manager, object_id='#settings_label'),
                'star_mass_slider': UIHorizontalSlider(relative_rect=pygame.Rect(65, 370, 145, 20), start_value=20000,
                                                       value_range=(10000, 30000), manager=self.manager),
                ...
                'general_title': UILabel(relative_rect=pygame.Rect(10, 447, 200, 30), text='General',
                                         manager=self.manager, object_id="#subtitle"),
                'glow_label': UILabel(relative_rect=pygame.Rect(10, 482.5, 50, 20), text='Glow: ',
                                      manager=self.manager, object_id='#settings_label'),
                'glow_button': UIButton(relative_rect=pygame.Rect(60, 480, 25, 25), text='',
                                        manager=self.manager, object_id='#radio_button'),
                'grid_label': UILabel(relative_rect=pygame.Rect(100, 482.5, 50, 20), text='Grid: ',
                                      manager=self.manager, object_id='#settings_label'),
                'grid_button': UIButton(relative_rect=pygame.Rect(150, 480, 25, 25), text='',
                                        manager=self.manager, object_id='#radio_button'),
                'trace_label': UILabel(relative_rect=pygame.Rect(10, 510.5, 50, 20), text='Trace: ',
                                       manager=self.manager, object_id='#settings_label'),
                'trace_button': UIButton(relative_rect=pygame.Rect(60, 508, 25, 25), text='',
                                         manager=self.manager, object_id='#radio_button'),
            }
        }
