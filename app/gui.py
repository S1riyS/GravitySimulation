    ...
    def __init__(self):
        ...
        self.settings_block = {
            'elements': {
                ...
                'glow_label': UILabel(relative_rect=pygame.Rect(10, 482.5, 50, 20),
                                      text='Glow: ', manager=self.manager, object_id='#settings_label'),
                'glow_button': UIButton(relative_rect=pygame.Rect(60, 480, 25, 25),
                                        text='',
                                        manager=self.manager),
                'grid_label': UILabel(relative_rect=pygame.Rect(100, 482.5, 50, 20),
                                      text='Grid: ', manager=self.manager, object_id='#settings_label'),
                'grid_button': UIButton(relative_rect=pygame.Rect(150, 480, 25, 25),
                                        text='',
                                        manager=self.manager),
